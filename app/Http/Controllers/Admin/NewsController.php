        ...
        return DataTables::of($news)
            ...
            ->addColumn(
                ...
                function ($news) {
                    ...
                    $actions .= '<a href=' . route('admin.news.confirm-delete', $news->id) . ' data-bs-toggle="modal" data-bs-target="#delete_confirm" data-id="'.$news->id.'"><i class="livicon" data-name="trash" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete News" ></i></a>';
