    ...
    public function data()
    {
        ...
        return DataTables::of($files)
            ...
            ->addColumn(
                'actions',
                function ($file) {
                    return '<a  data-id="'.$file->id.'" data-bs-toggle="modal" data-bs-target="#delete_confirm"><i class="livicon" data-name="trash" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete user"></i></a>';
                }
            )
