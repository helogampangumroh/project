(function ($) {
    ...
    $(document).ready(function () {
        ...
        var r = $('#R').bootstrapSlider().on('slide', RGBChange).data('bootstrapSlider');
        var g = $('#G').bootstrapSlider().on('slide', RGBChange).data('bootstrapSlider');
        var b = $('#B').bootstrapSlider().on('slide', RGBChange).data('bootstrapSlider');
