(function ($) {
    ...
    $(document).ready(function () {
                ...
                $('#btnGenerate').on('click', function () {
                    ...
                    $('.item').each(function () {
                        ...
                        if (
                            ...
                            htmlValue =
                                $(this).find('.drdHtmlType').val() +
                                ':' +
                                $(this).find('.txtHtmlValue').val();
                        } else {
                        ...
                        fieldArr.push({
                            fieldInput:
                                $(this).find('.txtFieldName').val() +
                                ':' +
                                $(this).find('.txtdbType').val(),
                            htmlType: htmlValue,
        ...
        $('#txtModelName').on('keyup', function () {
            ...
            var modelname = {
                modelName: Str.ucfirst(modalName),
            };
            $.ajax({
                url: modelCheckUrl,
                type: 'POST',
            ...
            var tableName = Str.plural(modalName);
