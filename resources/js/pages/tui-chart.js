...
document.addEventListener('DOMContentLoaded', function () {
    ...
    };
    {
        ...
        const options = {
            ...
            responsive: autorespone,
        };
        const chart1 = toastui.Chart.areaChart({ el, data, options });
    }
    {
        const el = document.getElementById('chart8');
        const data = {
            categories: {
                x: [
                    'Jan',
    ...
    {
        const el = document.getElementById('chart7');
        const data = {
            series: [
                {
                    label: 'Documents',
        ...
        const options = {
            chart: { title: 'Used disk space', width: 'auto', height: 'auto' },
    ...
    {
        const el = document.getElementById('chart9');
        const data = {
            series: [
                {
                    name: 'male',
        ...
        const options = {
            chart: { title: 'Height vs Weight', width: 'auto', height: 'auto' },
    ...
    }
    {
        ...
        const chart = toastui.Chart.bubbleChart({ el, data, options });
    }
    {
        const el = document.getElementById('chart11');
        const data = {
        ...
        const chart = toastui.Chart.radarChart({ el, data, options });
    }
    {
        const el = document.getElementById('chart12');
        const data = {
            categories: ['Browser'],
            series: [
                {
