<ul id="navigation" class="slimmenu">
    ...
    <li class="main-menu option-one"><a href="javascript:void(0)" {!! Request::is('admin') || Request::is('admin/index1') ? 'class="menu-list active"' : 'menu-list' !!}><span
                class="d-block d-lg-none">Index</span><span class="d-none d-lg-block">Dashboards</span></a>
        <ul>
    ...
    <li class="main-menu"><a href="javascript:void(0)" {!! Request::is('admin/generator_builder') ||
    Request::is('admin/log_viewers') ||
    Request::is('admin/custom_datatables') ||
    Request::is('admin/multiple_upload')
        ? 'class="menu-list active"'
        : 'menu-list' !!}>Laravel</a>
        <ul>
            <li><a href="javascript:void(0)" {!! Request::is('admin/generator_builder') ||
            Request::is('admin/log_viewers') ||
            Request::is('admin/custom_datatables') ||
            Request::is('admin/multiple_upload')
                ? 'class="sub-list active"'
                : 'sub-list' !!}>Laravel Examples</a>
                <ul>
                    <li>
            ...
            <li><a href="javascript:void(0)" {!! Request::is('admin/laravel_charts') || Request::is('admin/database_charts')
                ? 'class="sub-list active"'
                : 'sub-list' !!}>Laravel Charts</a>
                <ul>
                    <li>
    ...
    <li class="main-menu"><a href="javascript:void(0)" {!! Request::is('admin/roles/*') ||
    ...
    <li class="main-menu"><a href="javascript:void(0)" {!! Request::is('admin/apexcharts') ||
    ...
    Request::is('admin/tui-charts')
        ...
        <ul>
            <li>
                <a href="{{ URL::to('admin/apexcharts') }}" {!! Request::is('admin/apexcharts') ? 'class="sub-list active"' : 'sub-list' !!}>
                    Apex Charts
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ URL::to('admin/tui-charts') }}" {!! Request::is('admin/tui-charts') ? 'class="sub-list active"' : 'sub-list' !!}>
                    ToastUI Charts
                </a>
            </li>
        </ul>
    ...
    <li class=""><a href="javascript:void(0)" {!! Request::is('admin/lockscreen') ||
    Request::is('admin/invoice') ||
    Request::is('admin/blank') ||
    Request::is('admin/login') ||
    Request::is('admin/register') ||
    Request::is('admin/horizontal_layout')
        ? 'class="menu-list active"'
        : 'menu-list' !!}>Pages </a>
        <ul>
            <li>
