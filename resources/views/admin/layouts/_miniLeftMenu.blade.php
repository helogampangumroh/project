<ul id="menu" class="metismenu navigation">
    ...
    <li {!! Request::is('admin/laravel_charts') || Request::is('admin/database_charts')
    ...
    Request::is('admin/datepicker') | Request::is('admin/advanced_datepickers')
        ...
        : 'class="menu-dropdown"' !!}>
        <a href="#">
            <i class="livicon menu-icon" data-name="doc-portrait" data-c="#67C5DF" data-hc="#67C5DF" data-size="18"
                data-loop="true"></i>
    ...
    <li {!! Request::is('admin/calendar') ? 'class="active"' : '' !!}>
        <a href="{{ URL::to('admin/calendar') }}">
            ...
            <span class="badge bg-danger event_count mm-text">7</span>
        </a>
    </li>
    ...
    <li {!! Request::is('admin/tasks') ? 'class="active"' : '' !!}>
        <a href="{{ URL::to('admin/tasks') }}">
            ...
            <span class="badge bg-danger mm-text" id="taskcount">{{ Request::get('tasks_count') }}</span>
        </a>
    </li>
    ...
    <li {!! Request::is('admin/news') || Request::is('admin/news_item')
        ? 'class="active menu-dropdown"'
        : 'class="menu-dropdown"' !!}>
        <a href="#">
    ...
    <li {!! Request::is('admin/invoice') || Request::is('admin/blank')
        ? 'class="active menu-dropdown"'
        : 'class="menu-dropdown"' !!}>
        <a href="#">
