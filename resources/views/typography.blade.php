    ...
    <div class="container my-3">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-4 col-12 col-sm-4">
                ...
                <dl class="row dl_horizontal">
                    <dt class="col-sm-3 col-lg-6 col-md-6 text-end">Description lists</dt>
                    <dd class="col-sm-9 col-lg-6 col-md-6">A description list is perfect for defining terms.</dd>
                    <dt class="col-sm-3 col-lg-6 col-md-6 text-end ">Question</dt>
                    <dd class="col-sm-9 col-lg-6 col-md-6">
                        Vestibulum id ligula porta felis euismod semper eget lacinia odio sem nec elit.
                    </dd>
                    <!--<dd >Donec id elit non mi porta gravida at eget metus.</dd>-->
                    <dt class="col-sm-3 col-lg-6 col-md-6 text-end">Progress bar</dt>
                    <dd class="col-sm-9 col-lg-6 col-md-6">Etiam porta sem malesuada magna mollis euismod.</dd>
                    <dt class="col-sm-3 col-lg-6 col-md-6 text-end">Answer</dt>
                    <dd class="col-sm-9 col-lg-6 col-md-6">
            ...
            <div class="col-md-12 col-lg-4 col-sm-4 col-12">
                ...
                <div class="float-end">
                    <ul class="list-unstyled ">
                        <li class="text-warning">The ship set ground on the shore of this uncharted desert isle with
                            Gilligan the
                            Skipper</li>
                        <li class="text-success">too the millionaire and his wife. Just two good ol' boys Fightin' the
                            system
                            like a true</li>
                        <li class="text-primary">modern day Robin Hood. So join us here each week my friends you're sure to
                            get a
                            smile</li>
                        <li class="text-danger">from seven stranded castaways here on Gilligans Isle.It's time to put on
                            makeup.
                        </li>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-lg-8  col-sm-12 col-12">
                <h3><label class="p-0">Text Align</label></h3>
                <h4 class="text-start"><b>Left aligned text.</b></h4>
                <p class="text-start">Wouldn't you like to get away? Sometimes you want to go where everybody knows your
                    name. </p>
                ...
                <p class="text-center">Wouldn't you like to get away? Sometimes you want to go where everybody knows your
                    name.</p>
                <h4 class="text-end"><b>Right aligned text.</b></h4>
                <p class="text-end">Wouldn't you like to get away? Sometimes you want to go where everybody knows your
                    name.</p>
                ...
                <figure>
                    <blockquote class="blockquote">
                        ...
                        <p>Latte cultivar single origin fair trade acerbic doppio white. Redeye, con panna, et, cafe au lait
                            ...
                            galao. Coffee instant affogato, percolator to go macchiato, extra cream coffee single shot
                            viennese
                            redeye. Brewed trifecta froth, caramelization breve arabica sweet cinnamon. Coffee dripper
                            carajillo
