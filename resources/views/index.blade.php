            ...
            <div class="container bg-border wow pulse" data-wow-duration="2.5s">
                <div class="row">
                    <div class="col-md-7 col-sm-12 col-12 col-lg-8">
                        <h1 class="purchase-hed mt-3">Excellent admin template for laravel</h1>
                    </div>
                    <div class="col-md-5 col-sm-12 col-12 col-lg-4"><a href="#"
                            class="btn purchase-styl float-end">Purchase
                            now</a></div>
                </div>
            </div>
        </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 col-sm-4 col-12 wow lightSpeedIn" data-wow-duration="2s">
                    <ul class="list-unstyled  text-end layout-styl">
                        <li>
        ...
        <div class="row">
                    ...
                    <div class="tabbable-line">
                        ...
                        <ul class="nav nav-tabs ">
                            ...
                            <li class="clear_both nav-item">
                                <a href="#tab_default_3" data-bs-toggle="tab" class="nav-link">
                                    CSS 3 </a>
                            </li>
                            <li class="nav-item">
                                <a href="#tab_default_4" data-bs-toggle="tab" class="nav-link">
                                    Bootstrap </a>
                            </li>
                        </ul>
            ...
            <div class="col-md-6 col-sm-12 col-12 col-lg-6 wow slideInRight " data-wow-duration="3s">
                <div class="accordion" id="accordion">
                    ...
                    <div class="accordion-item mb-2">
                        <div class="accordion-header p-0" id="headingThree">
                            <h5 class="mb-0">
                                <button class="btn" type="button" data-bs-toggle="collapse"
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-12 wow zoomInLeft" data-wow-duration="3s">
                ...
                <p class="text-end primary my-2"><a href="#">Read more</a>
                </p>
            </div>
            <!-- //What we are End -->
            <!-- About Us Start -->
            ...
            <div class="col-md-4  col-lg-4 col-12 wow bounceInLeft" data-wow-duration="3s">
                <div class="author">
                    <img src="{{ asset('images/authors/avatar3.jpg') }}" alt="avatar3"
                        class="img-fluid rounded-circle float-start">
                    <p class="text-end">
                        Tonny Jakson
                        <br>
                        <small class="text-end">Themeforest.net</small>
                    </p>
                    <p>
