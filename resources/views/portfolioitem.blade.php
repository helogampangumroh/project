                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div id="owl-demo" class="owl-carousel owl-theme">
                            <div class="item"><img src="{{ asset('images/16.jpg') }}" alt="slider-image"
                                    class="img-fluid">
                            </div>
                            <div class="item"><img src="{{ asset('images/14.jpg') }}" alt="slider-image"
                                    class="img-fluid">
                            </div>
                            <div class="item"><img src="{{ asset('images/15.jpg') }}" alt="slider-image"
                                    class="img-fluid">
                            </div>
                        </div>
                    </div>
