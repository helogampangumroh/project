    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-lg-6 col-12 wow bounceInRight" data-wow-duration="3s">
                ...
                <div id="accordion" class="about_acc">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body">
                                <div class="media d-flex">
                                    <div class="media-top mt-1 p-2 ps-0">
                                        <a href="#">
                    ...
                    <div class="accordion-item mb-2">
                        ...
                        <div id="collapsetwo" class="accordion-collapse collapse" aria-labelledby="headingtwo"
                            ...
                            <div class="accordion-body">
                                <div class="media d-flex">
                                    <div class="media-left media-top mt-1 p-2 ps-0">
                                        <a href="#">
        ...
        <div class="row">
                ...
                <div class="thumbnail bg-white  text-center">
                    ...
                    <div class="caption">
                        ...
                        <div class="divide">
                            ...
                            <a href="#"> <i class="livicon" data-name="google-plus" data-size="22"
                                    data-loop="true" data-c="#d73d32" data-hc="#d73d32"></i>
                            </a>
            ...
            <!-- Image3 Section End -->
            <!-- Image4 Section Star -->
            <div class="col-md-6 col-sm-5 col-12  col-lg-3 profile wow zoomIn" data-wow-duration="3s"
                data-wow-delay="0.8s">
                <div class="thumbnail bg-white text-center">
