...
@section('content')
    ...
    <div class="container my-3">
        <h2 class="mb-3 ms-2">Portfolio</h2>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="mix category-2" data-my-order="5">
                                ...
                                <div class="thumb_zoom"><img src="{{ asset('images/gallery/5.jpg') }}"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="mix category-2" data-my-order="6">
                                ...
                                <div class="thumb_zoom"><img src="{{ asset('images/gallery/4.jpg') }}"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="mix category-1" data-my-order="7">
                                ...
                                <div class="thumb_zoom"><img src="{{ asset('images/gallery/3.jpg') }}"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="mix category-2" data-my-order="8">
                                ...
                                <div class="thumb_zoom"><img src="{{ asset('images/gallery/2.jpg') }}"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="mix category-2" data-my-order="8">
                                ...
                                <div class="thumb_zoom"><img src="{{ asset('images/gallery/1.jpg') }}"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="mix category-1" data-my-order="8">
                                ...
                                <div class="thumb_zoom"><img src="{{ asset('images/gallery/11.jpg') }}"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="mix category-1" data-my-order="8">
                                ...
                                <div class="thumb_zoom"><img src="{{ asset('images/gallery/12.jpg') }}"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="mix category-2" data-my-order="8">
                                ...
                                <div class="thumb_zoom"><img src="{{ asset('images/gallery/9.jpg') }}"
                                        class="img-fluid">
                                </div>
                            </div>
                        </div>
