        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold">HTC Desire 816G Plus - (Blue)</h5>
                    <ul>
                    ...
                    <div class="d-grid">
                        <a href="{{ URL::to('single_product') }}" class="btn btn-primary  text-white">View</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class=" thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold">Sony Xperia C3 - (Black)</h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
                                data-hc="787878"></i> Android v4.4.2 (KitKat)</li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="1s" data-wow-delay="0.9s">
                <div class=" thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold">Karbonn Titanium Octane Plus</h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
            ...
            <div class="col-sm-6 col-md-6  col-lg-3 wow flipInX" data-wow-duration="1s" data-wow-delay="1.4s">
                <div class=" thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold">Microsoft Lumia 535 Dual SIM </h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold">Samsung Galaxy S6 32 GB - (Black)</h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
                                data-hc="787878"></i> Android OS, v5.0.2 (Lollipop)</li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class=" thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold">Samsung Galaxy S6 64 GB - (White)</h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
                                data-hc="787878"></i> Android OS, v5.0.2 (Lollipop)</li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
            ...
            <div class="col-sm-6 col-md-6  col-lg-3 wow flipInX" data-wow-duration="1s" data-wow-delay="0.9s">
                <div class=" thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/samsung balck.jpg') }}"
                            class="img-fluid" alt="samsung black image"></a>
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold">Samsung Galaxy S6 Edge 32 GB</h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
                                data-hc="787878"></i> Android OS, v5.0.2 (Lollipop)</li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="1s" data-wow-delay="1.4s">
                <div class=" thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/samsung.jpg') }}"
                            class="img-fluid" alt="samsung image"></a>
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold">Samsung Galaxy S6 Edge 64 GB </h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
                                data-hc="787878"></i> Android OS, v5.0.2 (Lollipop)</li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold"> Vichitra Multi Colour Will Make Your Day Floral
                        Printed Saree</h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold"> Diva Fashion Brown Vibrant Saree With Mixed Print
                    </h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
                                data-hc="787878"></i> Product Type - Women's Saree</li>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="1s" data-wow-delay="0.9s">
                <div class="thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold"> Bunkar Purple Ethnic Motif Resham Work Saree</h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
                                data-hc="787878"></i> Product Type - Women's Saree</li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="1s" data-wow-delay="1.4s">
                <div class="thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold"> Silk Bazaar Silk Casual Wear Saree - Rust Work
                        Saree</h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
                                data-hc="787878"></i> Product Type - Women's Saree</li>
            ...
            <div class="col-12 text-end">
                <a href="{{ URL::to('category') }}" class="more_items ms-auto">More items</a>
            </div>
        </div>
        <!-- //Womens Section End -->
        <!-- Mens Section Start -->
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6  col-lg-3 wow flipInX" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold"> Mario Solid Shirt</h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold"> Inmark White Linen Crafted Shirt</h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
                                data-hc="787878"></i> Product -Men's Club Wear</li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="1s" data-wow-delay="0.9s">
                <div class="thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold"> Andrew Solid Shirt</h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
                                data-hc="787878"></i> Product -Men's Club Wear</li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
            ...
            <div class="col-sm-6 col-md-6  col-lg-3 wow flipInX" data-wow-duration="1s" data-wow-delay="1.4s">
                <div class="thumbnail text-center">
                    ...
                    <br />
                    <h5 class="text-primary mt-4 mb-2 fw-bold"> Atelier Check Shirt</h5>
                    <ul>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
                                data-hc="787878"></i> Product -Men's Club Wear</li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878"
