                    ...
                    <div class="thumbnail">
                        ...
                        <div class="p-1 relative-left">
                            <h3 class="text-primary"><a
                                    href="{{ URL::to('blogitem/' . $blog->slug) }}">{{ $blog->title }}</a>
                            </h3>
                            <p>
                                {!! $blog->content !!}
                            </p>
            ...
            <div class="ms-auto col-md-4 col-lg-4 col-12">
                    ...
                    <div class="tabbable-line">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane  fade show active" id="tab_default_1">
                                ...
                                <div class="text-end primary mb-1"><a href="#">Read more</a>
                                </div>
                                <div class="media">
                                ...
                                <div class="text-end primary"><a href="#">Read more</a>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="tab_default_2">
                                    ...
                                    <div class="media-left media-middle tab col-sm-12 col-12">
                                        <a href="#">
                                            <img class="media-object img-fluid my-2"
                                                src="{{ asset('images/img_5.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="media">
                                    <div class="media-left tab col-sm-6 col-md-12 col-12">
                                        <a href="#">
                                            <img class="media-object img-fluid my-2"
                                                src="{{ asset('images/img_3.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <h4 class="text-primary">Jelly-o sesame snaps</h4>
                ...
                <div class="recent p-3 border radius mb-3">
                    ...
                    <div class="media d-flex align-items-start">
                        <a class="float-start flex-1" href="#">
                            <img src="{{ asset('images/authors/avatar.jpg') }}" class="rounded-circle" alt="riot">
                        </a>
                    ...
                    <div class="media d-flex align-items-start">
                        <a class="float-start" href="#">
                            <img src="{{ asset('images/authors/avatar1.jpg') }}" class="rounded-circle" alt="riot">
                        </a>
                        <div class="media-body ms-3">
                            <h4 class="media-heading primary">
                    ...
                    <div class="media d-flex align-items-start">
                        <a class="float-start" href="#">
                            <img src="{{ asset('images/authors/avatar5.jpg') }}" class="rounded-circle" alt="riot">
                        </a>
                        <div class="media-body ms-3">
                            <h4 class="media-heading primary">
