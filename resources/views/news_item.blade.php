                    ...
                    <div class="tab-pane active" id="tab_default_1">
                        <div class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img class="media-object me-3" src="{{ asset('images/image_13.jpg') }}" alt="image">
                                </a>
                            </div>
                            <div>
                                <a href="#">
                        ...
                        <div class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img class="media-object me-3" src="{{ asset('images/image_14.jpg') }}"
                                        alt="image">
                                </a>
                            </div>
                            <div>
                        ...
                        <div class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img class="media-object me-3" src="{{ asset('images/image_15.jpg') }}"
                                        alt="image">
                                </a>
                            </div>
                            <div>
