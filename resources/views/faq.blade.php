                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="card-group card-accordion faq-accordion">
                            <div id="faq">
                                <div class="accordion-item mix category-1 col-lg-12 card mb-2" data-value="1">
                                    <div class="accordion-header bg-white py-2" id="headingOne">
                                        <h4 class="accordion-title my-0">
                                            <a data-bs-toggle="collapse" data-bs-target="#question1" aria-expanded="true"
                                    ...
                                    <div id="question1" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                        data-bs-parent="#faq">
                                ...
                                <div class="accordion-item mix category-1 col-lg-12 mb-2 card" data-value="2">
                                    <div class="accordion-header bg-white py-2" id="headingTwo">
                                        <h4 class="accordion-title my-0">
                                            <a data-bs-toggle="collapse" data-bs-target="#question2" aria-expanded="false"
                                    ...
                                    <div id="question2" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                        data-bs-parent="#faq">
                                ...
                                <div class="accordion-item mix category-1 col-lg-12 mb-2 card" data-value="3">
                                    <div class="accordion-header bg-white py-2" id="headingThree">
                                        <h4 class="accordion-title my-0">
                                            <a data-bs-toggle="collapse" data-bs-target="#question3" aria-expanded="false"
                                    ...
                                    <div id="question3" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                        data-bs-parent="#faq">
                                ...
                                <div class="accordion-item mix category-2 col-lg-12 mb-2 card" data-value="4">
                                    <div class="accordion-header bg-white py-2" id="headingFour">
                                        <h4 class="accordion-title my-0">
                                            <a data-bs-toggle="collapse" data-bs-target="#question4" aria-expanded="false"
                                    ...
                                    <div id="question4" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                        data-bs-parent="#faq">
                                ...
                                <div class="accordion-item mix category-1 col-lg-12 mb-2 card" data-value="5">
                                    <div class="accordion-header bg-white py-2" id="headingFive">
                                        <h4 class="accordion-title my-0">
                                            <a data-bs-toggle="collapse" data-bs-target="#question5"
                                ...
                                <div class="accordion-item mix category-2 col-lg-12 mb-2 card" data-value="6">
                                    <div class="accordion-header bg-white py-2" id="headingSix">
                                        <h4 class="accordion-title my-0">
                                            <a data-bs-toggle="collapse" data-bs-target="#question6"
                                    ...
                                    <div id="question6" class="accordion-collapse collapse" aria-labelledby="headingSix"
                                        data-bs-parent="#faq">
                                ...
                                <div class="accordion-item mix category-3 col-lg-12 mb-2 card" data-value="7">
                                    <div class="accordion-header bg-white py-2" id="headingSeven">
                                        <h4 class="accordion-title my-0">
                                            <a data-bs-toggle="collapse" data-bs-target="#question7"
                                ...
                                <div class="accordion-item mix category-3 col-lg-12 mb-2 card" data-value="8">
                                    <div class="accordion-header bg-white py-2" id="headingEight">
                                        <h4 class="accordion-title my-0">
                                            <a data-bs-toggle="collapse" data-bs-target="#question8"
                                ...
                                <div class="accordion-item mix category-2 col-lg-12 mb-2 card" data-value="9">
                                    <div class="accordion-header bg-white py-2" id="headingNine">
                                        <h4 class="accordion-title my-0">
                                            <a data-bs-toggle="collapse" data-bs-target="#question9"
                                    ...
                                    <div id="question9" class="accordion-collapse collapse" aria-labelledby="headingNine"
                                        data-bs-parent="#faq">
                                        <div class="accordion-body">
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis earum
