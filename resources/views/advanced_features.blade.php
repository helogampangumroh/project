...
@section('top')
    <div class="breadcum">
        <div class="container advfeature">
            <div class="row">
                <div class="col-12">
                    <ol class="breadcrumb">
                        <li>
                    ...
                    <div class="float-end d-none d-lg-block d-sm-block d-md-block mt-1">
                        <i class="livicon icon3" data-name="rocket" data-size="20" data-loop="true" data-c="#3d3d3d"
                            data-hc="#3d3d3d"></i>Advanced Features
                    </div>
                    <div class="float-end  d-lg-none d-sm-none d-md-none mt-1">
                        <i class="livicon icon3" data-name="rocket" data-size="20" data-loop="true" data-c="#3d3d3d"
    ...
    <div class="container advfeatures">
        ...
        <div class="row advanced">
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12">
                <h3>Buttons</h3>
                <button type="button" class="btn button-alignment btn-secondary" data-bs-toggle="button">Submit</button>
                <button type="button" class="btn button-alignment btn-success" data-bs-toggle="button">Submit</button>
                <button type="button" class="btn button-alignment btn-primary" data-bs-toggle="button">Submit</button>
                <button type="button" class="btn button-alignment btn-warning text-white"
                    data-bs-toggle="button">Submit</button>
                <button type="button" class="btn button-alignment btn-danger" data-bs-toggle="button">Submit</button>
            </div>
            <!-- //Button Section End -->
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-2">
                <div class="bs-example rounded">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="">
                            <a class="nav-link disabled" id="contact-tab" data-bs-toggle="tab" href="#"
                                role="tab" aria-controls="contact" aria-selected="false">Disabled</a>
                        </li>
                    </ul>
                    ...
                    <div class="tabbable-line">
                        ...
                        <div class="tab-content my-2">
                            <div class="tab-pane  fade active show" id="tab_default_1">
                                <div id="accordion" class="accordion mt-0">
                                ...
                                <div id="accordion1">
                                    ...
                                    <div class="card my-2">
                                        <div class="card-header" id="headingFour">
                                            <span>
                                                <a data-bs-toggle="collapse" data-parent="#accordion1"
                                                    href="#collapsefour" class="text-success">
                                                    <span class=" fa fa-plus"></span>
        ...
        <!-- Panel Section Start -->
        <h3 class="margin-left13">Cards</h3>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6 pop d-none d-sm-block mb-2">
                ...
                <button type="button" class="btn btn-secondary" title="Popover title" data-bs-container="body"
                    data-bs-toggle="popover" data-bs-placement="left" data-bs-content="Popover on left">Popover
                    left</button>
                <button type="button" class="btn btn-primary" title="Popover title" data-bs-container="body"
                    data-bs-toggle="popover" data-bs-placement="top" data-bs-content="Popover on top">Popover
                    top</button>
                <button type="button" class="btn btn-success" title="Popover title" data-bs-container="body"
                    data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content="Popover on bottom">Popover
                    bottom</button>
                <button type="button" class="btn btn-warning text-white" title="Popover title" data-bs-container="body"
                    data-bs-toggle="popover" data-bs-placement="right" data-bs-content=" popover on right">Popover
                    right</button>

            </div>
            <div class="col-md-6 pop d-block d-sm-none d-md-none d-lg-none margin-bottom-left">
                <h3>Popover</h3>
                <button type="button" class="btn btn-warning" title="Popover title" data-bs-container="body"
                    data-bs-toggle="popover" data-bs-placement="right" data-bs-content=" Popover on right">Popover on
                    right</button>
                <button type="button" class="btn btn-primary" title="Popover title" data-bs-container="body"
                    data-bs-toggle="popover" data-bs-placement="top" data-bs-content=" Popover on top">Popover on
                    top</button>
                <button type="button" class="btn btn-success" title="Popover title" data-bs-container="body"
                    data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content=" Popover on bottom">Popover on
                    bottom</button>
                <button type="button" class="btn btn-secondary" title="Popover title" data-bs-container="body"
                    data-bs-toggle="popover" data-bs-placement="left" data-bs-content="Popover on left">Popover on
                    left</button>
            </div>
            <!-- Popover End -->
        </div>
