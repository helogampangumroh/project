                        ...
                        <div class="form-inline col-md-12" style="padding:15px 15px;text-align: right">
                            ...
                            <div class="form-group" style="border-color: transparent;padding-left: 10px">
                                <button type="button" class="btn btn-secondary btn-flat" id="btnReset"
                                    data-bs-toggle="modal" data-bs-target="#confirm-delete"> Reset
                                </button>
                            </div>
                        </div>
...
<script>
    ...
    $(function() {
        ...
        $(document).ready(function() {
            ...
            var commonComponent = $(htmlStr).filter("tr").load(
                '{!! url('') !!}/field_template');
            ...
            $("#form").on("submit", function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        $("#info").html("");
                        $("#info").append(
                            '<div class="alert alert-success alert-dismissible"><a href="#" class="btn-close" data-bs-dismiss="alert" aria-label="close"></a><strong>' +
                            result + '</strong></div>');
                        $("#info").show();
                    ...
                    error: function(result) {
                        $("#info").html("");
                        $("#info").append(
                            '<div class="alert alert-danger alert-dismissible"><a href="#" class="btn-close" data-bs-dismiss="alert" aria-label="close"></a><strong>Fail!</strong>result</div>'
                        );
                        $("#info").show();
                        setTimeout(function() {
                            $('#info').fadeOut('fast');
